Config.PoliceEvidence = vector3(472.9, -994.58, 26.27) --/evidence # while near MRPD Evidence Locker
Config.PoliceEvidence2 = vector3(1849, 3694.82,30.27) --/evidence # while near SO Evidence Locker

Config.Stashes = {
	{ coords = vector3(472.9, -994.58, 26.27), slots = 1000, name = 'Police Evidence', job = 'police', grade = 4 }, --Public Evidence Locker MRPD
	{ coords = vector3(1849, 3694.82,30.27), slots = 1000, name = 'Police Evidence', job = 'police', grade = 4 }, -- Public Evidence Locker SO
